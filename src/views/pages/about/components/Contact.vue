      ...
      <b-row class="align-items-center pt-1 pb-2 py-lg-4">
        <b-col xl="4" lg="5" md="6" class="offset-lg-1 mb-4 pb-3 mb-md-0 pb-md-0">
          ...
          <p class="pb-2 pb-md-4 pb-lg-5">
            Your all-in-one notary service: Document printing, preparation, scanning, delivery, 
            and execution, with bilingual English/Spanish support. Seamless, efficient notarization.
          </p>
          ...
          <ul class="list-unstyled pb-3 pb-md-4 pb-lg-5 mb-2">
            ...
            <li class="mb-2">
              <a href="mailto:example@email.com?subject=New Notary Inquiry" class="nav-link d-flex align-items-center p-0">
          ...
          <div class="d-flex">
            ...
            class="btn btn-icon btn-outline-secondary btn-instagram me-3"
