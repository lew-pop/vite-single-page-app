      ...
      <b-row class="justify-content-center text-center pt-xl-2 pb-4 mb-1 mb-lg-3">
        <b-col xl="6" lg="7" md="8" sm="11">
          ...
          <p class="text-muted mb-0">
            Bilingual notary services in English and Spanish to meet your document authentication needs. 
            Mobile and local services available. Contact us for seamless notarization.
          </p>
        </b-col>
      </b-row>
